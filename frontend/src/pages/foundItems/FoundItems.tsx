    ...
    return (
      <div className="bg-white dark:bg-gray-900 min-h-screen">
        <div className="py-8 px-4 mx-auto max-w-screen-2xl sm:py-6 lg:px-6">
          ...
          {/* Search Skeleton */}
          <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 mb-8 shadow-sm">
            <div className="max-w-4xl mx-auto">
              <div className="h-12 bg-gray-300 dark:bg-gray-700 rounded-xl mb-6 animate-pulse"></div>
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="h-10 bg-gray-300 dark:bg-gray-700 rounded-lg flex-1 animate-pulse"></div>
    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen">
            ...
            <form className="mb-6" onSubmit={handleSearch}>
              ...
              <div className="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="block w-full p-4 ps-12 text-sm text-gray-900 border border-gray-300 rounded-xl bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 transition-all duration-200"
                ...
                <button
                  type="submit"
                  className="text-white absolute end-3 bottom-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-all duration-200"
                >
                  Search
                </button>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <select
                  ...
                  className="block w-full sm:w-64 p-3 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 transition-all duration-200"
                >
              ...
              {searchTerm && (
                <button
                  onClick={clearSearch}
                  className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium bg-blue-50 dark:bg-blue-900/30 px-4 py-2 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all duration-200"
                >
                  Clear search
                </button>
              )}
        ...
        {foundItems?.data?.length === 0 ? (
          <div className="text-center py-16">
            ...
            {searchTerm && (
              <button
                onClick={clearSearch}
                className="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200"
              >
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    {foundItem?.isClaimed ? (
                      ...
                      <div className="absolute top-3 right-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 py-1.5 rounded-full text-xs font-semibold shadow-lg backdrop-blur-sm border border-blue-400/50">
                        🔍 Available
                      </div>
                    )}
                  </div>
      ...
      {totalPages > 1 && (
        <div className="flex flex-col items-center mt-12 pb-8 space-y-4">
          ...
          <nav className="inline-flex items-center space-x-1 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-2">
            {/* Previous Button */}
            <button
              ...
              className={`inline-flex items-center px-4 py-2 text-sm font-medium rounded-xl transition-all duration-200 ${
                currentPage === 1
                  ...
                  : "text-gray-700 bg-gray-50 hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 hover:scale-105"
              }`}
            >
                ...
                if (startPage > 1) {
                  pages.push(
                    <button
                      ...
                      className="px-3 py-2 text-sm font-medium rounded-lg text-gray-700 bg-gray-50 hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 transition-all duration-200 hover:scale-105"
                    >
                      1
                    </button>
                  );
                    ...
                    <button
                      ...
                      className={`px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 hover:scale-105 ${
                        currentPage === i
                          ...
                          : "text-gray-700 bg-gray-50 hover:bg-gray-100 dark:text-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600"
                      }`}
                    >
                      {i}
                    </button>
          ...
          {totalPages > 10 && (
            <div className="flex items-center space-x-2 text-sm">
              ...
              <input
                ...
                className="w-16 px-2 py-1 text-center border border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700 dark:text-white"
              />
              <span className="text-gray-600 dark:text-gray-400">
                of {totalPages}
              </span>
